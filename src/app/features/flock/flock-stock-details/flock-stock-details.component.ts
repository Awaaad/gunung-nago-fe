...
export class FlockStockDetailsComponent implements OnInit {
  ...
  public language = "en";
  public displayedColumns: string[] = ['age', 'flockCategory', 'cageName', 'alive', 'death', 'sterile', 'good', 'amountOfChickenWeighted', 'totalWeight', 'averageWeight', 'createdBy', 'createdDate', 'lastModifiedBy', 'lastModifiedDate'];
